...
'Date        : 8-25-2003
'Description : Basically, this is a graphical program that i'll update later on
'              as a screen saver. There are numbers of small circles forming
'              a ring that rotates multiple rotations. It rotates in all 3D dimentions.
'              It spins around it's center, it rotates around the x-axis, and it rotates
'              around the y-axis. It also moves in all 3D dimentions. There is also
'              color rotation and a fading effect which add an artistic touch to the
'              program .

'              You can get 4 different styles of drawing ( Circles or lines ) by
'              doing some changes in the precedure TmrDraw_Timer. You can also do
'              some changes to the variables (Size, Number of circles, Vels, and Colors ).

'              I hope you'll like it.


'              Question or comments, yehia_sm@hotmail.com

'Modification : 9-24-2003
'               Showing the setting form so that you can choose the style of rotation
'               and whether you want fading effect of not, and other options...
